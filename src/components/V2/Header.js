...
function Navbar() {
    ...
    const renderBalance = async () => {
        ...
        // const beViralBalance = await Moralis.Web3.getERC20({chain:'bsc', tokenAddress: '0x33a6b5AC6dF354b98189B5BeF7D57653fB7e265B'});
                    ...
                    <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                        ...
                        {user &&
                            <>
                                ...
                                <li className='nav-item'>
                                    <Link to='/myfeed' className='nav-links' onClick={closeMobileMenu}>
                                        My&nbsp;Feed
                                    </Link>
                                </li>
                                <li className='nav-item'>
